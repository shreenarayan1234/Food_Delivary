...
const Nav = () => {
  return (
    <div className='w-full h-[100px] flex justify-between text-center px-8 py-3'>
        ...
        <IoSearch className='text-green-500 w-[20px] h-[20px]'/>
            <form action="">
                <input type="text" placeholder='Search your dishes......' className='w-[100%] outline-none text-[20px] relative'/>
            </form>
        </div>
        <div className="w-[60px] h-[60px] bg-white flex justify-center items-center rounded-md shadow-xl">
