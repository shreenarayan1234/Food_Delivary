...
const Card = ({id, name, price, type, image}) => {
  ...
  return (
    <div className='w-[300px] h-[400px] bg-white p-3 rounded-lg flex flex-col gap-3 shadow-lg hover:border-2 border-green-300'>
        ...
        <button className='bg-green-700 text-white font-bold text-lg rounded-lg hover:bg-green-400 transaction-all cursor-pointer' onClick={()=> {dispatch(AddItem({id:id, name:name, price:price, image:image, qty:1}));
